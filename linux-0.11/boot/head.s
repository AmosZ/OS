...
gdt:
	...
	/*
	   ...
	   G = 4KB (16MB)
	   P = 1
	   DPL = 0 (0x9a00 == B 1001| 1010 | 0000| 0000)
	   Type = B1010 (E | ED/C | W/R | A)
		|--	E  = Execuable
		|-- ED = Extend (0: Extend to high) (when E == 0 )
		|				(1: Extend to low )
		|-- C	(0: common code) ??
		|		(1: special code)Shared ???
		|-- R	(0: Unreadable )
		|		(1: Readable   )
		|-- W	(0: Unwritable)(when E == 0)
		|		(1: Writable)
		|-- A accessed
	*/
	...
	/*
	   ...
	   G = 4KB (16MB)
	   P = 1
	   DPL = 0 (0x9200 == B 1001| 0010 | 0000| 0000)
	   Type = B0010
	*/
