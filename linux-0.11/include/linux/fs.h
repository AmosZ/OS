...
/* these are in memory also */
	struct task_struct * i_wait; //Processes that block on this inode
...
/*
	Kernel use struct file to manage operation to files..
	
*/


struct file {
	unsigned short f_mode; //operation mode RW?
	unsigned short f_flags;//Open and control mode??? What ??
	unsigned short f_count;// file descriptor number?
